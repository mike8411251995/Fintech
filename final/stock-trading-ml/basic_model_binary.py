...
# ohlcv_histories, _, next_day_open_values, unscaled_y, y_normaliser = csv_to_dataset('final/TX_daily.csv')
...
y_train = next_day_open_higher[:n]

ohlcv_test = ohlcv_histories[n:]
# y_test = next_day_open_values[n:]
y_test = next_day_open_higher[n:]
